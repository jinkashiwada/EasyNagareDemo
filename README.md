...
- `index_incompressible.html`: 日本語版の作業バックアップ。
- `index_v1.html`, `index_current_ui_v1_model.html`, `index_kk_scheme_backup.html`: 検討過程のバックアップ。
...
- `index_incompressible.html`: Working backup of the Japanese incompressible version.
- `index_v1.html`, `index_current_ui_v1_model.html`, `index_kk_scheme_backup.html`: Backups from the development process.
